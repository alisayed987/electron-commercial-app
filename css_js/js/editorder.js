...
document.getElementById('orderbtn').addEventListener('click', () => {
    ...
    newrow.innerHTML = '<tr id="row' + ocount + '">' +
        '<td>' + ocount + '</td>' +
        '<td><select class="form-control" onchange="price(this)" id="menuelist' + ocount + '"></select></td>' +
...
function price(a) {
    ...
    ipcRenderer.send('getItem', { "index": index, "str": document.getElementById('menuelist' + index).value });
};
//------------------------------------------------------
...
function save() {
    ...
    ipcRenderer.send('updateOrder', {"id":id,"data":updateobj});
    ipcRenderer.on('updatedOrder', (event, lol) => { alert('updated') })
